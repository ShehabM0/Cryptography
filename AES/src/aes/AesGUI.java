...
public class AesGUI extends JFrame {
	...
	public AesGUI() {
		...
		JLabel title = new JLabel("Aes Encryption Program");
		...
		btnFile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) { // Select File.
		        ...
		        fileChooser.setCurrentDirectory(new File("/home/shehab/Materials/cs402/lab"));
...
//		comboBox.addItem("decryption");
	...
	private void case1() {
		try {
	        ...
	        if(box == "hexadecimal") is_hexa = true;
	        
	        String line = reader.readLine();
	        while(line != null) {
	            System.out.println(k);
	        	Aes a = new Aes(line, k, is_hexa);
	            String resStr = a.encrypt(); 
	            writer.write(resStr + '\n');
