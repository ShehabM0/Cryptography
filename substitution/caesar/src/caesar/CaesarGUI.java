...
public class CaesarGUI extends JFrame {
	...
	private final String RESLUT_PATH = "/home/shehab/Materials/cs402/lab/results.txt";
	File resultedFile = new File(RESLUT_PATH);
	String path = null;
	int k = -1;
	...
	private void case1() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter(RESLUT_PATH));
	        BufferedReader reader = new BufferedReader(new FileReader(path));
	        
	        String line = reader.readLine();
	        while(line != null) {
	            Caesar ceaser = new Caesar();
	            String resStr = ceaser.encryption(line, k);
	            writer.write(resStr + '\n');
	...
	private void case2() {
		try {
	        ...
	        while(line != null) {
	            Caesar ceaser = new Caesar();
	            String resStr = ceaser.decryption(line, k);
	            writer.write(resStr + '\n');
	            line = reader.readLine();
	        }
	        reader.close();
